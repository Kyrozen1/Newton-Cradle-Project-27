...
function setup() {
	...
	roof = new Roof(820, 10, 1900, 20);
	bob1 = new Bob(504, 350, 40);
	bob2 = new Bob(582, 350, 40);
	bob3 = new Bob(660, 350, 40);
	bob4 = new Bob(738, 350, 40);
	bob5 = new Bob(816, 350, 40);
...
function keyPressed() {
	if (keyCode === UP_ARROW) {
	//Give the ball foece
	Matter.Body.applyForce(bob1.body, bob1.position,{x:-520,y:1});
